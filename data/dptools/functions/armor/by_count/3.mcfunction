...
execute if entity @s[tag=carm.thre] run function dptools:armor/mend/one

#else discard first, and roll to determine two is selected
execute if entity @s[tag=!carm.thre] run function dptools:armor/by_count/remove
...
execute if entity @s[tag=!carm.thre,tag=!carm.twoo] run function dptools:armor/by_count/remove
execute if entity @s[tag=!carm.thre,tag=!carm.twoo] run function dptools:armor/mend/one
