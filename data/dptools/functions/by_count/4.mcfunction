...
execute if entity @s[tag=!carm.four] run function dptools:by_count/remove
...
execute if entity @s[tag=!carm.four,tag=!carm.thre] run function dptools:by_count/remove
...
execute if entity @s[tag=!carm.four,tag=!carm.thre,tag=!carm.twoo] run function dptools:by_count/remove
execute if entity @s[tag=!carm.four,tag=!carm.thre,tag=!carm.twoo] run function dptools:mend/one
